...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/okex/exchain/libs/ibc-go/modules/testing/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
